...
In this guide, we are going to walk through an example with the logit model, as implemented by `glm()` in the [stats](https://stat.ethz.ch/R-manual/R-devel/library/stats/html/00Index.html) packageto Zelig.
